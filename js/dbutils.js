...
var db = {
	...
	sendRemote: function(json,id,from){
		...
		var url = "http://193.51.249.49:83/restcotnc/cot-fj.php";
		...
		xhr.onreadystatechange = function () { 
				...
				if(json.status)	{
				    if(from == "form"){
					app.updateMsg("Thanks for reporting acanthasters, data will be processed as soon as possible."); 
		    			app.close();
				    } else {
				    	app.updateMsg("The form has been sent (found connexion).");
				    }
				} else {
