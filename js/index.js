 ...
 var app = {
   ...
   updateMsg: function(msg) {
    ...
    isOnline: function(no,yes){
        ...
        xhr.open("GET","http://vcot-monitoring.ird.nc/fisheries/index.php?option=com_api&app=restcot&resource=restcot&format=raw&key=02e788534b81a1d354e85a5002d4be5d",true);
        xhr.send();
    },
